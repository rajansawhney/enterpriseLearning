...
gulp.task('compile', function() {
  return wb
    ...
    .on('error', function (err) {
      ...
      // fs.createWriteStream("build/app_cb.js")
      fs.createWriteStream("build/app_p.js")
        .write(
    ...
    .pipe(fs.createWriteStream("build/app_p.js"))
    // .pipe(fs.createWriteStream("build/app_cb.js"))
    
    // write the whole shabang to the build dir
})
